...
<head>
  ...
  <title>HKReal Estate Rental Management System</title>
                ...
                <table class="table table-borderless" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    if (isset($_POST['submit'])) {
                      ...
                      $query1 = "SELECT * FROM tenant_in WHERE username = '$id'";
                      ...
                      $query3 = "SELECT * FROM tenant_in WHERE username = '$username'";
                      ...
                      if(mysqli_num_rows($rs) == 0){
                        if(!is_numeric($units)){
                          ...
                          $sql = "INSERT INTO tenant_in(`in_id`, `username`, `stat_keyholder`, `stat_electricityRemote`, `no_bulbs`, `stat_bulbs`, `stat_paint`, `stat_Windows`, `stat_toiletSink`, `stat_washingSink`, `stat_doorLock`, `stat_toiletDoorLock`, `water_units`, `comments`, `date_reg`, `status`)
                          VALUES (' ','$username','$h_key','$remote','$nbulb','$bulb','$paint','$window','$tsink','$wsink','$lock','$tlock','$units','$msg','$date','$status')";
