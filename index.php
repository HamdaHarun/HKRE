    ...
    <header class="header mb-5">
      ...
      *** TOPBAR ***
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="index.php" class="navbar-brand home"><img src="rent_3.png" alt="RHMS logo" class="d-none d-md-inline-block"></a>
          <div class="col-lg-6 offer mb-3 mb-lg-0"><a href="index.php" class="ml-1" style="text-decoration:none"><b><b><b><b><b><b>HK REAL ESTATE RENTAL MANAGEMENT SYSTEM</b></b></b></b></b></b></a></div>
          <div class="col-lg-6 text-center">
            <ul class="menu list-inline mb-0">
              ...
              <li class="list-inline-item"><a href="admin_login.php">Admin Login</a></li>
            </ul>
          </div>
                ...
                <div class="product">
                  ...
                  <div class="text">
                    ...
                    <p class="price">
                      ...
                      $sql = "SELECT * FROM houses WHERE rent_per_month = 50000 AND status = 'Empty'";
              ...
              <div class="item">
                <div class="product">
                  ...
                  <div class="text">
                    ...
                    <p class="price">
                      Available Rooms:<br/><?php
                      $sql = "SELECT * FROM houses WHERE rent_per_month = 60000 AND status = 'Empty'";
                      $query = mysqli_query($con,$sql);
                      $num = mysqli_num_rows($query);
                      echo $num;
                       ?>
              ...
              <div class="item">
                <div class="product">
                  ...
                  <div class="text">
                    ...
                    <p class="price">
                      Available Rooms:<br/><?php
                      $sql = "SELECT * FROM houses WHERE rent_per_month = 70000 AND status = 'Empty'";
                      $query = mysqli_query($con,$sql);
                      $num = mysqli_num_rows($query);
                      echo $num;
                       ?>
              ...
              <div class="item">
                <div class="product">
                  ...
                  <div class="text">
                    ...
                    <p class="price">
                      Available Rooms:<br/><?php
                      $sql = "SELECT * FROM houses WHERE rent_per_month = 80000 AND status = 'Empty'";
                      $query = mysqli_query($con,$sql);
                      $num = mysqli_num_rows($query);
                      echo $num;
                       ?>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-2 mb-lg-0">
            <p class="text-center text-lg-left">Copyright &copy; HK 2022</p>
          </div>
        </div>
      </div>
    </div>
