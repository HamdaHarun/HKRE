              ...
              <div class="table-responsive">
                <table class="table table-borderless" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT * FROM tenant WHERE username = '$id'";
                    ...
                    do{
                      ...
                      echo '<tr>';
                      echo "<td>Contact:</td>";
                      echo "<td style = 'color:blue;'>".$row['contact']."</td>";
                      echo '<tr>';

                      echo '<tr>';
                      echo "<td>Address</td>";
                      echo "<td style = 'color:blue;'>".$row['address']."</td>";
                      echo '<tr>';

                      echo '<tr>';
                      echo "<td>Nationality</td>";
                      echo "<td style = 'color:blue;'>".$row['nationality']."</td>";
                      echo '<tr>';
                    ...
                    if(isset($_POST['submit'])){
                      ...
                      $query2 = "UPDATE tenant SET $col = '$edit' WHERE username = '$id'";
                     ...
                     <option value = 'contact'>Phone Number 2 e.g; 0754******</option>
                     <option value = 'email'>Email Address</option>
                     <option value = 'address'>Postal Address</option>
                     <option value = 'region'>nationality</option>
                   </select></td>
