...
if(!($_SESSION['username'] == "Admin")){
 ...
 <head>
   ...
   <title>HK Real Estate Management System</title>
   ...
   <div id="wrapper">
     ...
     <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
       ...
       <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admin_home.php">
         ...
         <div class="sidebar-brand-text mx-3">HK Real Estate Management System</div>
       </a>
                 ...
                 <table class="table table-borderless" id="dataTable" width="100%" cellspacing="0">
                     ...
                     <tr>
                       ...
                       <td>
                         <select class="custom-select" name="stat" style="width:300px;">
                           ...
                           <option value = "3">Contact the System Administrator.</option>
                           <option value = "2">Contract has Expired.</option>
                         </select>
                       </td>
                     </tr>
                     <tr>
                   ...
                   if(isset($_POST["submit"])){
                     ...
                     $stat = $_POST["stat"];
                       ...
                       $sql1 = "UPDATE tenant SET status= '$stat', checkout='0' WHERE username = '$id'";
