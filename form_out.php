                   ...
                   <tbody>
                     <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method = "POST">
                       <tr>
                         ...
                         <td>
                           <select class="custom-select" name="username" style="width:300px;" required>
                     ...
                     if (isset($_POST['submit'])) {
                       ...
                       $query3 = "SELECT * FROM tenant_out WHERE username = '$username'";
                       $rs = mysqli_query($con, $query3);
                       if(mysqli_num_rows($rs) == 0){

                         $sql = "INSERT INTO tenant_out(`out_id`, `username`, `stat_keyholder`, `stat_electricityRemote`, `no_bulbs`, `stat_bulbs`, `stat_paint`, `stat_Windows`, `stat_toiletSink`, `stat_washingSink`, `stat_doorLock`, `stat_toiletDoorLock`, `comments`, `date_reg`)
                         VALUES (' ','$username','$h_key','$remote','$nbulb','$bulb','$paint','$window','$tsink','$wsink','$lock','$tlock','$msg','$date')";
