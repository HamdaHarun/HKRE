               ...
               <div class="table-responsive">
                 <table class="table table-borderless" id="dataTable" width="100%" cellspacing="0">
                   ...
                   <tbody>
                     <form action="add.php" method = "POST">
                       <tr>
                         ...
                         <td><input type='text' class='form-control form-control-user' name='house_no' required></td>
                       </tr>
                     ...
                     <tr>
                       ...
                       <td>
                         <input type='number' class='form-control form-control-user' name='house_floor' required>
                       </td>
                     </tr>
                     <tr>
                       <td>
                       ...
                       <td>
                         <textarea class='form-control form-control-user' name='house_desc' required></textarea>
                       </td>
                     </tr>
                     <tr>
                       <td>
                       ...
                       <td>
                         <select class="custom-select" name="rent_per_month" id="terms" style="width:300px;" required>
                   ...
                   if(isset($_POST["submit"])){
                     ...
                     $status =  "Empty";
                     $sql= "INSERT INTO houses VALUES ('$house_no','$house_floor','$	house_desc','$rent_per_month','$status')";
